  ...
  <form action="{$urls.pages.contact}" method="post" {if $contact.allow_file_upload}enctype="multipart/form-data"{/if}>
    ...
    {if !$notifications || $notifications.nw_error}
      <section class="form-fields">
        ...
        {if isset($smarty.get.rdv)}
          <div class="form-group row">
            <label class="col-md-3 form-control-label">{l s='Rendez-vous' d='Shop.Forms.Labels'}</label>
            <div class="col-md-6">
              <input class="form-control datepicker" name="rendezvous" placeholder="{l s='Date:' d='Shop.Forms.Labels'}">
            </div>
          </div>
